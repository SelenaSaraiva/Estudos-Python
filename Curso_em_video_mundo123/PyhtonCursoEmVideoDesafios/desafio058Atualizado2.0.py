print('                 Bem vindo(a) ao chutando certo! (ATUALIZADO 2.0)           ')
print('Olá! Meu nome é Ezio, sou seu amigo aqui no chutando certo. Vamos brincar de advinhar? ')
print("Vou pensar em um número inteiro de 0 a 10 e você tem que tentar adivinhar em que número pensei. Se você acertar, você ganha! ")
...
while adnum != num:
    if adnum < num:
        ...
        adnum = int(input('Um pouco mais ... Tente de novo: '))
    elif adnum > num:
        print('\033[4;31mRESPOSTA ERRADA!\033[m')
        adnum = int(input('Um pouco menos ... Tente de novo: '))
    cont = cont + 1
